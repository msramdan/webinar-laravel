                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <h6 class="text-muted mb-1">Template Sertifikat:</h6>
                                @if ($seminar->template_sertifikat)
                                    <img src="{{ asset('storage/uploads/sertifikat_templates/' . $seminar->template_sertifikat) }}"
                                        alt="Template Sertifikat" class="img-thumbnail mt-1"
                                        style="max-width: 250px; height: auto;">
                                @else
                                    <p class="text-muted mt-1">Belum ada template yang diunggah.</p>
                                @endif
                            </div>
                            ...
                            @else
                                <div class="row">
                                    @foreach ($pembicaras as $pembicara)
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="card-text text-muted small">
                                                                {{ Str::limit($pembicara->latar_belakang, 100) }}</p>
                                                            <a href="#" class="btn btn-sm btn-outline-primary"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#pembicaraModal{{ $pembicara->id }}">
                                                                Lihat Profil
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <!-- Pembicara Modal -->
                                        <div class="modal fade" id="pembicaraModal{{ $pembicara->id }}" tabindex="-1"
                                            aria-labelledby="pembicaraModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="pembicaraModalLabel">
                                                            {{ $pembicara->nama_pembicara }}</h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            @if ($sesi->link_gmeet)
                                                                <a href="{{ $sesi->link_gmeet }}" target="_blank"
                                                                    class="btn btn-sm btn-outline-success">
                                                                    <i class="bi bi-camera-video"></i>
                                                                </a>
                                                            @endif
                                                            @if ($sesi->lampiran)
                                                                <a href="{{ asset('storage/uploads/sesi/' . $sesi->lampiran) }}"
                                                                    target="_blank"
                                            ...
                                            <div class="card border-0 text-center p-3 h-100">
                                                <div class="card-body">
                                                    <img src="{{ $sponsor->gambar ? asset('storage/uploads/sponsor/' . $sponsor->gambar) : 'https://via.placeholder.com/150?text=No+Image' }}"
                                                        class="img-fluid mb-2" style="max-height: 80px; width: auto;"
