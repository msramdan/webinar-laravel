                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" id="link_gmeet" name="link_gmeet" placeholder="https://meet.google.com/xxx-yyyy-zzz">
                            </div>
                            <div class="form-group">
                                <label for="lampiran">Lampiran (PDF/DOC)</label>
                                <input type="file" class="form-control" id="lampiran" name="lampiran" accept=".pdf,.doc,.docx">
...
<script>
    $(document).ready(function() {
        ...
        let table = $('#sesi-table').DataTable({
            ...
            order: [[4, 'asc']] // Default order by tanggal_pelaksanaan
        });
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: xhr.status === 404 ? 'Sesi tidak ditemukan' : 'Gagal memuat data sesi'
                    });
                }
            });
        });
