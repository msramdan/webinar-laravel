...
<script src="{{ asset('asset-peserta/temp/vendor/datatables/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('asset-peserta/temp/vendor/datatables/dataTables.bootstrap4.min.js') }}"></script>
